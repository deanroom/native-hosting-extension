...
NativePluginHostStatus native_plugin_host_create(native_host_handle_t* out_handle) {
    if (!out_handle) {
...
NativePluginHostStatus native_plugin_host_destroy(native_host_handle_t handle) {
    if (!handle) {
        return NATIVE_PLUGIN_HOST_ERROR_INVALID_ARG;
    }
...
NativePluginHostStatus native_plugin_host_load(
...
NativePluginHostStatus native_plugin_host_unload(
    native_host_handle_t host_handle,
...
NativePluginHostStatus native_plugin_host_get_function_pointer(
    native_host_handle_t host_handle,
    native_plugin_handle_t plugin_handle,
